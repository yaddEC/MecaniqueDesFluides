...
public class Scene1Manager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else if (physicManager.height > 0.001f && waterTower.holeSize > 0.0f)
        {
            ...
            {
                particule.transform.localScale = new Vector3(waterTower.holeSize * 0.5f, waterTower.holeSize * 0.5f, particule.transform.localScale.z);
            ...
            else
            {
                ...
                particule.transform.localScale = new Vector3(waterTower.WaterLevel.transform.localScale.y * 0.5f, waterTower.WaterLevel.transform.localScale.y * 0.5f, particule.transform.localScale.z);
            }
        }

        physicManager.orifice_diameter = waterTower.holeSize;
    }
}
